...
<div class="row">
	...
	<div class="col-md-6">
		...
		<div class="input-row">
			...
			{{ Form::textarea('diagnose', null, ['class' => ($errors->has('diagnose')) ? 'form-control warning' : 'form-control', 'rows' => 5, 'placeholder' => trans('admin.message.placeholders.order_diagnose_pl')]) }}
		</div>
