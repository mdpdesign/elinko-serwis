...
<div class="row">
		...
		<div class="row">
			<div class="col-md-7">
				<div class="input-row">
					...
					{{ Form::text('serial_number', null, ['class' => ($errors->has('serial_number')) ? 'form-control warning' : 'form-control', 'placeholder' => trans('admin.message.placeholders.order_serial_number_pl')]) }}
				</div>
			</div>
			...
			<div class="col-md-5">
				<div class="input-row">
					...
					{{ Form::text('pa_fv', null, ['class' => ($errors->has('pa_fv')) ? 'form-control warning' : 'form-control', 'placeholder' => trans('admin.message.placeholders.order_document_pl')]) }}
				</div>
			</div>
		</div>
		...
		<div class="row">
			...
			<div class="col-md-6">
				<div class="input-row">
					...
					{{ Form::text('client_phone', null, ['class' => ($errors->has('client_phone')) ? 'form-control warning' : 'form-control', 'placeholder' => trans('admin.message.placeholders.order_client_phone_pl')]) }}
				</div>
			</div>
		</div>
	...
	<div class="col-md-6">
		...
		<div class="row">
			<div class="col-md-6">
				<div class="input-row">
					...
					{{ Form::text('ext_service', null, ['class' => ($errors->has('ext_service')) ? 'form-control warning' : 'form-control', 'placeholder' => trans('admin.message.placeholders.order_ext_service_pl')]) }}
				</div>
			</div>
			...
			<div class="col-md-6">
				<div class="input-row">
					...
					<div class="input-group">
						{{ Form::text('price_netto', null, ['class' => ($errors->has('price_netto')) ? 'form-control warning' : 'form-control', 'placeholder' => trans('admin.message.placeholders.order_price_netto_pl')]) }}
		...
		<div class="input-row">
			...
			{{ Form::textarea('comments', null, ['class' => ($errors->has('comments')) ? 'form-control warning' : 'form-control', 'rows' => 4, 'placeholder' => trans('admin.message.placeholders.order_comments_pl')]) }}
		</div>

		<div class="input-row">
			{{ Form::label('accesories', trans('admin.message.order_accessories')) }}
			{{ Form::textarea('accesories', null, ['class' => ($errors->has('accesories')) ? 'form-control warning' : 'form-control', 'rows' => 3, 'placeholder' => trans('admin.message.placeholders.order_accessories_pl')]) }}
		</div>

		<div class="input-row">
			{{ Form::label('diagnose', trans('admin.message.order_diagnose')) }}
			{{ Form::textarea('diagnose', null, ['class' => ($errors->has('diagnose')) ? 'form-control warning' : 'form-control', 'rows' => 4, 'placeholder' => trans('admin.message.placeholders.order_diagnose_pl')]) }}
		</div>
