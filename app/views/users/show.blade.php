...
<div class="row">
	<div class="col-md-12">
		...
		{{ link_to_route('admin.settings.users.edit', trans('admin.message.buttons.edit'), array($user->id), array('class' => 'btn btn-primary', 'title' => trans('admin.message.edit_user'))) }}
		@else
